          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            <div>
              ...
              <p className="text-muted-foreground">
                Get the latest odds, bonuses, and betting tips delivered to your inbox.
              </p>
            </div>
            <div className="flex gap-2">
              <Input className="bg-background" placeholder="Enter your email" type="email" />
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-1">
            <div className="mb-6">
              ...
              <p className="text-sm text-muted-foreground mt-1">Your Premier Betting Platform</p>
            </div>
      ...
      <div className="max-w-7xl mx-auto py-8 border-t border-border">
        ...
        <div className="mt-6 p-4 bg-accent rounded-lg border border-border">
          <p className="text-muted-foreground text-xs leading-relaxed">
            <span className="font-semibold">Please Gamble Responsibly:</span> This site is intended
            for adult entertainment only. By using this site, you acknowledge that you are of legal
            age to gamble in your jurisdiction. If you feel you have a gambling problem, please
            visit{' '}
