...
const sportsCategories: { title: string; href: string; description: string }[] = [
  {
    ...
    description: 'Bet on Premier League, Champions League, and leagues worldwide.',
  },
  {
    title: 'Basketball',
    href: '/sports/basketball',
    description: 'NBA, EuroLeague, and international basketball betting markets.',
  },
  {
    title: 'Tennis',
    href: '/sports/tennis',
    description: 'Grand Slams, ATP, WTA tours with live in-play betting options.',
  },
  {
    title: 'Cricket',
    href: '/sports/cricket',
  ...
  },
  {
    ...
    description: 'Daily racing from tracks around the world with best odds guaranteed.',
  },
  {
    title: 'Esports',
    href: '/sports/esports',
    description: 'CS2, Dota 2, League of Legends, and major esports tournaments.',
  },
]
  ...
  return (
    <NavigationMenu className="hidden md:flex">
      <NavigationMenuList className="flex-wrap">
        <NavigationMenuItem>
          ...
          <NavigationMenuContent>
            <ul className="grid gap-2 md:w-[400px] lg:w-[500px] lg:grid-cols-[.75fr_1fr]">
              <li className="row-span-3">
                <NavigationMenuLink asChild>
                  ...
                  >
                    ...
                    <div className="mb-2 text-lg font-medium sm:mt-4">Featured Bets</div>
              ...
              <ListItem href="/live" icon={<TrendingUp className="size-4" />} title="Live Betting">
              ...
              <ListItem href="/promotions" icon={<Star className="size-4" />} title="Promotions">
          ...
          <NavigationMenuContent>
            <ul className="grid gap-2 sm:w-[400px] md:w-[500px] md:grid-cols-2 lg:w-[600px]">
              {sportsCategories.map((sport) => (
                <ListItem href={sport.href} key={sport.title} title={sport.title}>
                  {sport.description}
                </ListItem>
              ))}
            </ul>
        ...
        <NavigationMenuItem>
          <NavigationMenuLink asChild>
            <Link className="flex items-center gap-2" href="/live">
