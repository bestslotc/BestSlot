  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-background via-background to-accent/5 flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-md">
        ...
        <div className="absolute inset-0 bg-linear-to-r from-primary/10 to-accent/10 rounded-2xl blur-3xl opacity-50" />
        ...
        <div className="relative space-y-6">
          ...
          <div className="flex justify-center">
            <div className="relative">
              ...
              <div className="relative h-20 w-20 bg-linear-to-br from-primary to-accent rounded-full flex items-center justify-center">
