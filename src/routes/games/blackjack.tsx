    ...
    <div className="mx-auto max-w-3xl space-y-6">
      <Card className="border-border/50 bg-card/50 p-8 backdrop-blur-sm">
        ...
        <div className="mb-6 space-y-6 rounded-xl bg-accent/30 p-6">
          ...
          <div className="space-y-2">
            <div className="flex items-center justify-between">
              ...
              <span className="text-sm font-bold text-primary">
                {gameState === 'playing' && dealerHand.length > 0 ? '?' : dealerValue}
              </span>
            </div>
          ...
          <div className="space-y-2">
            <div className="flex items-center justify-between">
              <h3 className="text-sm font-semibold text-muted-foreground">Player</h3>
              <span className="text-sm font-bold text-primary">{playerValue}</span>
            </div>
            <div className="flex gap-2">
        ...
        {gameState === 'playing' && (
          <div className="grid grid-cols-2 gap-2">
            ...
            <Button onClick={stand} size="lg" variant="outline">
              Stand
            </Button>
          </div>
        )}
