    ...
    <div className="mx-auto max-w-2xl space-y-6">
      <Card className="border-border/50 bg-card/50 p-8 backdrop-blur-sm">
        ...
        <div className="mb-8 flex items-center justify-center gap-4 rounded-xl bg-accent/30 p-12">
          ...
          {!currentCard && <p className="text-muted-foreground">Start a game to play</p>}
        </div>
        ...
        {!gameActive && currentCard && nextCard && (
          <Card className="mb-6 border-destructive/50 bg-destructive/10 p-4">
            <div className="text-center">
              <p className="text-lg font-semibold text-destructive">Wrong guess!</p>
              <p className="text-sm text-muted-foreground">Streak ended at {streak}</p>
            </div>
          </Card>
        )}
