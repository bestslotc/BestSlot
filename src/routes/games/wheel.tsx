      ...
      <Card className="border-border/50 bg-card/50 p-8 backdrop-blur-sm">
            ...
            >
              {segments.map((segment, idx) => {
                ...
                return (
                  ...
                  >
                    <span className="text-xl font-bold text-white">{segment.multiplier}x</span>
                  </div>
                )
              })}
            </div>
            ...
            <div className="text-center">
              <p
                className={cn(
                  ...
                  result >= (selectedMultiplier || 0) ? 'text-primary' : 'text-destructive'
                )}
              >
                {result >= (selectedMultiplier || 0)
          ...
          <div className="grid grid-cols-3 gap-2">
            {segments.map((segment) => (
              <Button
                ...
                variant={selectedMultiplier === segment.multiplier ? 'default' : 'outline'}
              >
        ...
        <div className="space-y-4">
          ...
          <Button
            ...
            disabled={isSpinning || !selectedMultiplier || betAmount < 1 || betAmount > balance}
            onClick={spin}
            size="lg"
          >
