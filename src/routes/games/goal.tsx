...
function RouteComponent() {
  ...
  const [_selectedPosition, setSelectedPosition] = useState<Position | null>(null)
  ...
  const shoot = async (position: Position) => {
    ...
    const goaliePosition = positions[Math.floor(Math.random() * positions.length)]
      ...
      <Card className="border-border/50 bg-card/50 p-8 backdrop-blur-sm">
            ...
            <div className="mb-4 flex justify-center gap-2">
              {positions.map((pos) => (
                ...
                >
                  ...
                  {lastResult?.shot === pos && lastResult.shot !== lastResult.save && (
                    <div className="flex h-full items-center justify-center">
                      <span className="text-4xl">⚽</span>
                    </div>
                  )}
              ...
              <div className="text-center">
                <p
                  className={cn(
                    ...
                    lastResult.shot !== lastResult.save ? 'text-primary' : 'text-destructive'
                  )}
                >
        ...
        {!gameActive && lastResult && lastResult.shot === lastResult.save && (
          <Card className="mb-6 border-destructive/50 bg-destructive/10 p-4">
            <div className="text-center">
              <p className="text-lg font-semibold text-destructive">Goalkeeper saved it!</p>
